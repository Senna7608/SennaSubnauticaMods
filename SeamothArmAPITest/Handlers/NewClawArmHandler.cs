...
{
    public class NewClawArmHandler : ClawArmHandler, ISeamothArm
    {
        ...
        public void OnHit()
        {
            if (Seamoth.CanPilot() && Seamoth.GetPilotingMode())
            {
                ...
                if (targetObject)
                {
                    ...
                    VFXSurfaceTypeManager.main.Play(component2, vfxEventType, position, Quaternion.Euler(euler), Seamoth.transform);
