...
namespace CheatManager
{
    internal static class WarpTargets
    {
        ...
        public static readonly string[][] Targets = new string[][]
        {
            ...
            new string[] { "343 64 902",      "Precursor Teleport Entry (Mountains to Floating Island)"  },
            new string[] { "170 -1428 -367",  "Precursor Teleport Entry (Prison to Crag Field)"},
            new string[] { "190 -1428 -405",  "Precursor Teleport Entry (Prison to Lost River: Ghost Tree)"},
            new string[] { "333 -1428 -276",  "Precursor Teleport Entry (Prison to Koosh Zone)"},
            new string[] { "353 -1428 -314",  "Precursor Teleport Entry (Prison to Mushroom Forest)"},
            new string[] { "248 -1588 -316",  "Precursor Teleport Entry (Prison Aquarium to Gun: Outer)"},
            new string[] { "-35 -1212 113",   "Precursor Teleport Entry (Lava Castle to Gun: Inner)"},
            new string[] { "386 -90 1137",    "Precursor Teleport (Gun Inner)"  },
            new string[] { "-662 5 -1077",    "Precursor Teleport (Floating Island)"  },
            new string[] { "-943 -620 1019",  "Precursor Teleport (Lost River: Ghost Tree)"},
            new string[] { "1383 -298 762",   "Precursor Teleport (Koosh Zone)"     },
            new string[] { "-803 -227 408",   "Precursor Teleport (Mushroom Forest)"},
            new string[] { "-80 -290 -1363",  "Precursor Teleport (Crag Field)"     },
            ...
            new string[] { "420 132 1185",    "Top Gun"                         },
