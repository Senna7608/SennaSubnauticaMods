...
namespace Common.Helpers.Testing
{
    public static class PrefabHelper
    {
        public static GameObject __TESTOBJECT__ = null;        

        public static GameObject CreateMainMenuTestObject(TechType techType)
        {
            ...
            GameObject clone = CraftData.InstantiateFromPrefab(techType, true);
